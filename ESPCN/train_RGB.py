...
from utils_RGB import AverageMeter, calc_psnr
from dataset_RGB import ImageTrainDataset, ImageValidDataset
from model_RGB import ESPCN
...
if __name__ == '__main__':
    ...
    # dataloader
    train_set = ImageTrainDataset(train_set, upscale_factor)
    train_loader = DataLoader(train_set, batch_size=batch_size, num_workers=8, pin_memory=True)
    valid_set = ImageValidDataset(valid_set, upscale_factor)
